...
# Endpoints
RFXCOM_OREGON_ENDP_BATteryLOW	= 0
RFXCOM_OREGON_ENDP_TEMP		= 1
RFXCOM_OREGON_ENDP_HUMidity		= 2
RFXCOM_OREGON_ENDP_BARO		= 3
RFXCOM_OREGON_ENDP_RAINRATE	= 4
RFXCOM_OREGON_ENDP_RAINALL	= 5
RFXCOM_OREGON_ENDP_WINDDIR	= 6
RFXCOM_OREGON_ENDP_WINDSPD	= 7
RFXCOM_OREGON_ENDP_WINDAVG	= 8
RFXCOM_OREGON_ENDP_UV		= 9
RFXCOM_OREGON_ENDP_WEIGHT	= 10
RFXCOM_OREGON_ENDP_PHASE1	= 11
RFXCOM_OREGON_ENDP_PHASE2	= 12
RFXCOM_OREGON_ENDP_PHASE3	= 13
...
# Device config
RFXCOM_OREGON_CFG_TEMPF		= 0x01
RFXCOM_OREGON_CFG_PRESSBAR	= 0x02
RFXCOM_OREGON_CFG_RAININCH	= 0x04
RFXCOM_OREGON_CFG_WINDMILLE	= 0x08
RFXCOM_OREGON_CFG_WINDHR	= 0x10
RFXCOM_OREGON_CFG_WEIGHTLB	= 0x20
